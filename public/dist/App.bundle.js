  ...
  /******/ [
    ...
    /***/ function (module, exports, __webpack_require__) {
        ...
        if ($(window).width() < 960) {
          $(".grid-item").hover(
            ...
            function () {
              $(this)
                .children()
                .removeClass("icon-izbrisi-show", 2000, "swing");
            }
          );
        }
      });
      ...
      var client = algoliasearch(
        "I2MFF9YJMM",
        "4c90218eecba183027c6d91eaada15f2"
      );
        ...
        { hint: false },
        {
          ...
          templates: {
            ...
            suggestion: function suggestion(_suggestion) {
              ...
              return (
                '\n                  <span style="line-height: 1.8em;"><a style="width: 130% !important; font-size: 1em;" class="anchor-search brown-text" href="/vino/' +
                _suggestion.objectID +
                '">' +
                _suggestion._highlightResult.naziv.value +
                "</a></span>\n                  "
              );
            },
          },
